...
# Credits
# Cloned from: https://github.com/learncodebygaming/enb_bot
...
def bring_game_to_foreground(window_title):
...
def Play_main():
    initializePyAutoGUI()
    countdownTimer()
    # game_window_title = "Graal"
    # bring_game_to_foreground(game_window_title)
